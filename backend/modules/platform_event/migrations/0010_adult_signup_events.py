...
def extend_adult_signup_allow_lists(apps, schema_editor):
    ...
    schema_editor.execute(
        ...
        f"({_values(SECURITY_EVENT_REASON_CODES)}))"
    )
...
class Migration(migrations.Migration):
    atomic = True
    dependencies = [("platform_event", "0009_platform_operator_admin_events")]
    operations = [
        migrations.SeparateDatabaseAndState(
            database_operations=[
                migrations.RunPython(
                    extend_adult_signup_allow_lists,
