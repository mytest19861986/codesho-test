...
SECURE_TRANSPORT_ENABLED = env.bool("CODESHO_SECURE_TRANSPORT", default=False)
...
SESSION_COOKIE_SECURE = SECURE_TRANSPORT_ENABLED
CSRF_COOKIE_SECURE = SECURE_TRANSPORT_ENABLED
