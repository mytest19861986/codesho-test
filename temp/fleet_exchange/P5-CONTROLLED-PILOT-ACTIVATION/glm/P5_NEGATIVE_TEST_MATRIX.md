...
| **N5-25** | Inherited GUC Core Reference Gap | Malformed / unset / spoofed `app.current_tenant` GUC during tenant operations | Immediate SQL exception / transaction abort | Inherited Phase 4 GUC Core Gate (N4-01..N4-06); `GUC_VALIDATION_FAILED` |
