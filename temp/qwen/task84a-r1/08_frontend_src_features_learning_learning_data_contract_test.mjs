...
test("learning navigation and semantic course controls are present", () => { assert.match(screen, /href: "\/learning"/); assert.match(screen, /href: "\/dashboard"/); assert.match(screen, /aria-pressed=/); assert.match(screen, /role=\"status\"/); });
